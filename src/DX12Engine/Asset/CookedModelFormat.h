...
namespace DX12Engine
{
	...
	{
		return MakeChunkMask(CookedModelChunkType::Vertices) | MakeChunkMask(CookedModelChunkType::IndicesLOD) | MakeChunkMask(CookedModelChunkType::Meshes) | MakeChunkMask(CookedModelChunkType::Nodes) | MakeChunkMask(CookedModelChunkType::Materials) | MakeChunkMask(CookedModelChunkType::Strings);
	}
