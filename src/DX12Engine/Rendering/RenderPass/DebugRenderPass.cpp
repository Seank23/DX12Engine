...
namespace DX12Engine
{
	...
	void DebugRenderPass::Init()
	{
		...
		m_RenderTargets.emplace_back(ResourceManager::GetInstance().CreateRenderTargetTexture(DirectX::XMINT2(renderSize.x, renderSize.y), DXGI_FORMAT_R8G8B8A8_UNORM));
